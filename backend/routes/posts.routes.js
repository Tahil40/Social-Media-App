...
import { activeCheck, createPost, getAllPosts, deletePost, commentPost, getPostComments, deleteComment, incrementLikes } from "../controllers/posts.controller";
...
router.route("/post/add-like").post(incrementLikes);
